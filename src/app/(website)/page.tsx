...
export default function LandingPage() {
  ...
  const [jobs, setJobs] = useState<JobListing[]>([
    ...
    { id: '2', title: 'Payments Infrastructure Engineer', company: 'Stripe', location: 'Bangalore, IN', workStyle: 'Remote', type: 'Full-time', salary: '$165k - $210k/yr', match: '88% Match', timeAgo: '5h ago', experience: 'Mid level', logo: 'https://logo.clearbit.com/stripe.com' },
    { id: '3', title: 'Global Supply Chain Manager', company: 'DHL Logistics', location: 'Douala, CM', workStyle: 'Onsite', type: 'Full-time', salary: '$110k - $145k/yr', match: '85% Match', timeAgo: '1d ago', experience: 'Senior level', logo: 'https://logo.clearbit.com/dhl.com' },
    { id: '4', title: 'Investment Banking Analyst', company: 'Goldman Sachs', location: 'London, UK', workStyle: 'Hybrid', type: 'Full-time', salary: '$95k - $130k/yr', match: '96% Match', timeAgo: '1d ago', experience: 'Entry level', logo: 'https://logo.clearbit.com/goldmansachs.com' },
    { id: '5', title: 'Clinical Solutions Architect', company: 'UnitedHealth Group', location: 'Yaoundé, CM', workStyle: 'Remote', type: 'Contract', salary: '$120k+ /yr', match: '81% Match', timeAgo: '2d ago', experience: 'Mid level', logo: 'https://logo.clearbit.com/unitedhealthgroup.com' },
    { id: '6', title: 'Staff Software Engineer', company: 'Google Cloud', location: 'Hyderabad, IN', workStyle: 'Hybrid', type: 'Full-time', salary: '$190k - $250k/yr', match: '89% Match', timeAgo: '3d ago', experience: 'Senior level', logo: 'https://logo.clearbit.com/google.com' },
  ]);
