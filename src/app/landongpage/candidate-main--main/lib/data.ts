...
export const candidate = {
  ...
  heroBadge: 'HRYantra AI Powered Career Platform',
  heroLine1: 'Where dream meets opportunities',
  heroLine2: 'Learn, Earn and Grow with AI',
  heroAccent: 'Learn, Earn and Grow with AI',
...
export const commandCenterStats = [
  { id: 'communities', label: 'Build your communities', value: '01', unit: '', status: 'live', trend: 'Connect with peers, mentors, and talent circles that match your goals.' },
  { id: 'chats', label: 'Have personalized chats', value: '02', unit: '', status: 'active', trend: 'Talk with mentors and recruiters through conversations tailored to you.' },
  { id: 'referrals', label: 'Earn with referrals', value: '03', unit: '', status: 'growing', trend: 'Share openings and earn rewards when your referrals get hired.' },
  { id: 'interviewer', label: 'Be an interviewer', value: '04', unit: '', status: 'excellent', trend: 'Join interview panels, share expertise, and grow your professional brand.' },
  { id: 'aicv', label: 'Build AI-powered CV', value: '05', unit: '', status: 'excellent', trend: 'Create a stronger resume with AI guidance built for ATS and recruiters.' },
  { id: 'companies', label: 'Connect to companies', value: '06', unit: '', status: 'active', trend: 'Reach hiring teams and discover roles matched to your profile.' },
]
...
export const experiences = [
  {
    id: 'signup',
    company: 'WhatsApp Login',
    role: 'Step 1: Log In',
    period: 'Start',
    description: 'Enter your WhatsApp number, verify the OTP, and securely access your candidate account.',
    highlights: ['WhatsApp sign-in', 'Quick OTP', 'Secure access'],
    color: '#28A8E1',
  },
  {
    id: 'profile',
    company: 'CV Upload',
    role: 'Step 2: Upload Your CV',
    period: 'Next',
    description: 'Upload your latest CV so HRYantra AI can understand your skills, experience, and career goals.',
    highlights: ['Upload CV', 'AI profile scan', 'Skills identified'],
    color: '#28A8DF',
  },
  {
    id: 'explore',
    company: 'AI Job Matching',
    role: 'Step 3: Get Job Matches',
    period: 'Then',
    description: 'Receive personalized job matches based on your CV, preferences, location, and experience.',
    highlights: ['Relevant matches', 'Job-fit insights', 'Personalized roles'],
    color: '#0EA5E9',
  },
  {
    id: 'grow',
    company: 'Apply & Track',
    role: 'Step 4: Apply for Jobs',
    period: 'Ongoing',
    description: 'Review matched roles, apply with your CV, complete screening questions, and track every application.',
    highlights: ['Easy application', 'Screening flow', 'Live status tracking'],
    color: '#38BDF8',
  },
]
