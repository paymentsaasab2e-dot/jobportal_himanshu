...
export function JobCvTailorPanel({
  ...
  return (
    <section className="overflow-hidden rounded-[24px] border border-[rgba(32,152,200,0.22)] bg-[linear-gradient(180deg,rgba(32,152,200,0.10),rgba(255,255,255,0.98))] shadow-[0_18px_40px_rgba(32,152,200,0.10)]">
      <div className="border-b border-[rgba(32,152,200,0.14)] px-5 py-4 sm:px-6">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div className="flex min-w-0 flex-1 flex-col gap-4 sm:flex-row sm:items-start">
          <div className="min-w-0 flex-1 space-y-2">
            <p className="inline-flex items-center gap-2 text-[11px] font-semibold uppercase tracking-[0.16em] text-[#2098C8]">
          ...
          <div className="flex shrink-0 flex-wrap gap-2">
            ...
            <button
              ...
              onClick={onApply}
              disabled={isSaving || isApplying || isApplyingSuggestions}
              className="inline-flex items-center justify-center gap-2 rounded-xl bg-[#2098C8] px-5 py-2.5 text-sm font-semibold text-white shadow-[0_8px_20px_rgba(32,152,200,0.25)] transition hover:bg-[#2098C8] disabled:cursor-not-allowed disabled:opacity-60"
            >
      ...
      <div className="grid gap-0 lg:grid-cols-2">
        ...
        <div className="space-y-4 px-5 py-4 sm:px-6">
          <div>
            ...
            <ul className="mt-2 space-y-2">
              {suggestions.map((item, index) => (
                ...
                >
                  <BookmarkCheck className="mt-0.5 h-4 w-4 shrink-0 text-[#2098C8]" strokeWidth={2.1} />
                  <span>{item}</span>
                </li>
              ))}
            </ul>
          ...
          <button
            ...
            disabled={isSaving || isApplying || isApplyingSuggestions}
            className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-[#2098C8] px-4 py-3 text-sm font-bold text-white shadow-[0_10px_24px_rgba(32,152,200,0.28)] transition hover:bg-[#2098C8] disabled:cursor-not-allowed disabled:opacity-60"
          >
          ...
          <button
            ...
            disabled={isSaving || isApplying || isApplyingSuggestions}
            className="inline-flex w-full items-center justify-center rounded-xl border border-[rgba(32,152,200,0.20)] bg-white px-4 py-2.5 text-sm font-semibold text-[#2098C8] transition hover:bg-[rgba(32,152,200,0.06)] disabled:cursor-not-allowed disabled:opacity-60"
          >
            Tailor summary only
          </button>
        </div>
