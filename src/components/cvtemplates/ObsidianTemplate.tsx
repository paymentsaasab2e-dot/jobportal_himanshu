...
const s: Record<string, React.CSSProperties> = {
  wrapper:    { display: "flex", minHeight: 1123, fontFamily: "'Helvetica Neue', Arial, sans-serif", fontSize: 12, background: "#0f0f0f", color: "#e8e0d0", overflow: "visible", paddingBottom: 48 },
