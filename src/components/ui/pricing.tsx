...
export interface PricingProps {
  ...
  title?: string;
  description?: string;
  onPlanSelect?: (plan: PricingPlan, billing: { isMonthly: boolean }) => void;
}
  ...
  const handleToggle = (checked: boolean) => {
    ...
    if (checked && switchRef.current) {
      ...
      confetti({
        ...
        colors: ["#28A8E1", "#FC9620", "#08428c", "#64748b"],
        ticks: 200,
        gravity: 1.2,
        decay: 0.94,
        startVelocity: 30,
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3">
        {plans.map((plan, index) => (
          <motion.div
            ...
            className={cn(
              "relative flex flex-col rounded-2xl border bg-background p-6 text-center lg:flex lg:flex-col lg:justify-center",
