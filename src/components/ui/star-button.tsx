...
function useStarBorderPath(ref: React.RefObject<HTMLElement | null>) {
...
function StarBorderLayers({
	backgroundColor = "currentColor",
	borderWidth = 2,
	rainbow = false,
}: Pick<StarBorderStyleProps, "backgroundColor" | "borderWidth" | "rainbow">) {
	return (
		<>
			<div
				className={cn(
					"pointer-events-none absolute aspect-square inset-0 animate-star-btn opacity-90",
					rainbow
						? "star-border-rainbow-beam"
			...
			/>
			<div
				className="pointer-events-none absolute inset-0 border-black/10 z-[4] overflow-hidden rounded-[inherit]"
...
/** Animated star border shell — wraps blocks like the hero search form. */
export function StarBorder({
	...
	return (
		<div
			...
			className={cn("relative z-[3] w-full overflow-hidden", className)}
			{...props}
		>
			<StarBorderLayers
				backgroundColor={backgroundColor}
